...
const ListDiscHorizontal: React.FC<BaseProps> = ({
  children,
  className,
  style,
}) => {
  return React.createElement(
    ...
    {
      className: clsx(
        "list-disc pl-4 flex flex-row items-center" + workSans.className,
        className
      ),
      style,
    },
...
const ListNoneHorizontal: React.FC<BaseProps> = ({
  children,
  className,
  style,
}) => {
  return React.createElement(
    ...
    {
      className: clsx(
        "list-none flex flex-row items-center" + workSans.className,
        className
      ),
      style,
    },
